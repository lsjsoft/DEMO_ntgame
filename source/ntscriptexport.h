...
#define SWIG_name      "gs"
#define SWIG_init      luaopen_gs
#define SWIG_init_user luaopen_gs_user

#define SWIG_LUACODE   luaopen_gs_luacode
...
static int _wrap_print(lua_State* L) {
  ...
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("print",1,"char const *");
...
static int _wrap_addPlug(lua_State* L) {
  int SWIG_arg = 0;
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  
  SWIG_check_num_args("addPlug",2,2)
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("addPlug",1,"char const *");
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("addPlug",2,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
  arg2 = (char *)lua_tostring(L, 2);
  addPlug((char const *)arg1,(char const *)arg2);
...
static int _wrap_removePlug(lua_State* L) {
  int SWIG_arg = 0;
  char *arg1 = (char *) 0 ;
  
  SWIG_check_num_args("removePlug",1,1)
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("removePlug",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
  removePlug((char const *)arg1);
